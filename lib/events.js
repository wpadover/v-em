...
EventTransformer.prototype = {
  ...
  buildEvent: function (e) {
    ...
    if (this.EVENT_MAP.hasOwnProperty(parsedEventType)) {
      return _.merge(thisEvent, this.EVENT_MAP[parsedEventType](row));
    } else {
  ...
  parsePeriodStart: function(row) {
    return {
      'type': 'periodStart'
    };
  },

  parseFaceoff: function(row) {
    return {
      'type': 'faceoff'
    };
  },

  parseShot: function(row) {
    return {
      'type': 'shot'
    };
  },

  parseTakeaway: function(row) {
    return {
      'type': 'takeaway'
    };
  },

  parseStop: function(row) {
    return {
      'type': 'stop'
    };
  },

  parseHit: function(row) {
    return {
      'type': 'hit'
    };
  },

  parsePenalty: function(row) {
    return {
      'type': 'penalty'
    };
  },

  parseGoal: function(row) {
    return {
      'type': 'goal'
    };
  },

  parsePeriodEnd: function(row) {
    return {
      'type': 'periodEnd'
    };
  },

  parseGiveaway: function(row) {
    return {
      'type': 'giveaway'
    };
  },

  parseBlock: function(row) {
    return {
      'type': 'shot'
    };
  },

  parseMissedShot: function(row) {
    return {
      'type': 'shot'
    };
  },
  ...
  parseShootoutComplete: function(row) {
    return {
      'type': 'shootoutComplete'
    };
  },

  parseGameEnd: function(row) {
    return {
      'type': 'gameEnd'
    };
  }
