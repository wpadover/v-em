  ...
  parseGoal: function(rowText) {
    ...
    return {
      ...
      details: {
        ...
        type: matches[TYPE_IDX],
        location: {
          zone: matches[ZONE_IDX],
          distance: matches[DISTANCE_IDX]
        },
        primaryAssist: matches[PRIMARY_ASSIST_IDX] ?
          this.findPlayer(matches[TEAM_IDX], matches[PRIMARY_ASSIST_IDX])
          : undefined,
        secondaryAssist: matches[SECONDARY_ASSIST_IDX] ?
          this.findPlayer(matches[TEAM_IDX], matches[SECONDARY_ASSIST_IDX])
          : undefined,
      }
    };
  }
